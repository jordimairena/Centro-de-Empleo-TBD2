<template lang="html">
  <div class="contenedor">
     <div class="container4">
       ...
       <p class="center-align">
         <a name="empleado_delete" class="waves-effect waves-light btn" v-on:click="deleteEmpleador()">  Aceptar</a>
...
export default {
  ...
  methods:{
    deleteEmpleador(){
      ...
      this.$http.delete('http://localhost:8000/empleadores/deleteRTN/'+identificacion).then((response)=>{
